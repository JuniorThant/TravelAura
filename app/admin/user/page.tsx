...
async function BookingsPage() {
    ...
    return(
      <>
      <h1 className='text-center font-bold capitalize text-4xl'>Your Bookings</h1>
      {roomBookings.length>0 && <div className='mt-16'>
        <h4 className='mb-4 capitalize font-bold'>total bookings for stay : {roomBookings.length}</h4>
        <Table>
      ...
      {airBookings.length>0 && <div className='mt-16'>
        <h4 className='mb-4 capitalize font-bold'>total air ticket bookings : {airBookings.length}</h4>
        <Table>
            <TableCaption>A list of your recent bookings</TableCaption>
            <TableHeader>
              <TableRow>
      ...
      {tourBookings.length>0 && <div className='mt-16'>
        <h4 className='mb-4 capitalize font-bold'>total tour bookings : {tourBookings.length}</h4>
        <Table>
            <TableCaption>A list of your recent bookings</TableCaption>
            <TableHeader>
              <TableRow>
